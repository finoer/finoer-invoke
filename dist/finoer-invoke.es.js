...
class Database {
  constructor() {
    ...
    this.data = {}; // Cache data key that has been set up proxy;
  ...
  set(data, namespace) {
    ...
    let initialData = this.data[currentSpace] || {}; // 设置数据
...
export { $data, invoke, registerApps, router };
//# sourceMappingURL=finoer-invoke.es.js.map
